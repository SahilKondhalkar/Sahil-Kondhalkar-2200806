...
namespace Sahil_Kondhalkar_2200806.CustomerDataSetTableAdapters {
    ...
    public partial class Table1TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table1` WHERE ((`Cid` = ?) AND ((? = 1 AND `Cname` IS NULL) OR (`Cna" +
                "me` = ?)) AND ((? = 1 AND `Cphno` IS NULL) OR (`Cphno` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table1` (`Cid`, `Cname`, `Cphno`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Table1` SET `Cid` = ?, `Cname` = ?, `Cphno` = ? WHERE ((`Cid` = ?) AND ((" +
                "? = 1 AND `Cname` IS NULL) OR (`Cname` = ?)) AND ((? = 1 AND `Cphno` IS NULL) OR" +
                " (`Cphno` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Sahil_Kondhalkar_2200806.Properties.Settings.Default.CustomerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Cid, Cname, Cphno FROM Table1";
        ...
        public virtual int Fill(CustomerDataSet.Table1DataTable dataTable) {
        ...
        public virtual CustomerDataSet.Table1DataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CustomerDataSet.Table1DataTable dataTable = new CustomerDataSet.Table1DataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CustomerDataSet.Table1DataTable dataTable) {
